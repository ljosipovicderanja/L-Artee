  ...
  <div class="row wrapper">
    ...
    <div class="responsive-container col-md-4 cont3">
      ...
      <br><br>
        ...
        <br>
        <router-link to="/muzeji"><button type="button" class="btn odustani">Odustani</button></router-link>
          <br><br>
          <p v-if="prazna_forma==true" class="warning-poruka">Unesite sva polja!</p>
    </div>
</div>
    </div>
...
export default {
  ...
  methods: {
    ...
    Rezervacija(){
      ...
      if(this.odabrani_muzej!=''&&this.datum!=''&&this.broj_karata!=''&&this.user!='')
      {
